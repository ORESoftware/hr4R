...
define(
    ...
    function(){
        ...
        return {
			...
			"controllerViews/FluxCartApp": arguments[1],
			"reactComponents/FluxCart": arguments[2],
			"reactComponents/FluxCartApp": arguments[3],
			...
			"relViews/getAll/getAll": arguments[17],
			"relViews/jobs/jobsView": arguments[18],
			"standardViews/IndexView": arguments[19],
			"standardViews/dashboardView": arguments[20],
			"standardViews/footerView": arguments[21],
			"standardViews/headerView": arguments[22],
			"standardViews/homeView": arguments[23],
			"standardViews/loginView": arguments[24],
			"standardViews/overviewView": arguments[25],
			"standardViews/pictureView": arguments[26],
			"standardViews/portalView": arguments[27],
			"standardViews/registeredUsersView": arguments[28],
			"standardViews/userProfileView": arguments[29]
        }
  });