        ...
        var PictureList = React.createClass({displayName: "PictureList",
            ...
            render: function () {
                ...
                var pictures = this.state.pictures.map(function (p) {
                    return React.createElement(Picture, {ref: p.id, src: p.src, title: p.title, favorite: p.favorite, 
                ...
                var favorites = this.state.favorites.map(function (p) {
                    return React.createElement(Picture, {ref: p.id, src: p.src, title: p.title, favorite: true, 
